...
export function UserDetailsForm ({id, type, userData, subAccounts}: IUserDetailsFormProps) {
  ...
  const [authUserData, setAuthUserData] =
    React.useState<AuthUserWithAgencySigebarOptionsSubAccounts | null>(null)
